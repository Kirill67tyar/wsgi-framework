...
Старный подход заключался в том, что раньше создавали под каждый web-сервер
...
Коннектор совершает конфертацию байтов в словарь и передаёт уже на Python приложение

Под приложением на Python имеется ввиду код фреймворка и код приложения.

Ответ, когда мы произвели все необходимые действия с db
